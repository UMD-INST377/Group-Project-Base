// Retrieve the data
async function getTopRateData() {
  const MovieURL = 'https://api.themoviedb.org/3/movie/top_rated?api_key=b5fa8ab3e139be5c0b6e60ab752e3d09&language=en-US&page=1';
...
// Line graph of top rated movies
...
document.addEventListener('DOMContentLoaded', async () => OtherMain());
