...
import { importCrimeData } from '../middleware/loadCrimeData.js';

// here, basicControllers is a name we made up in this file, which exports an unnamed 'default' object
import crimeDataControllers from '../controllers/crimeDataControllers.js';
...
router
  ...
  .post((req, res) => crimeDataControllers.handlePostRequest(req, res))
  .put((req, res) => crimeDataControllers.handlePutRequest(req, res))
  .delete((req, res) => crimeDataControllers.handleDeleteRequest(req, res));
