...
//       console.log('You touched the crimeData Route!');
//       console.log('req.crimeData results in crimeDataPG GET', req.crimeData.length); // this information comes in through the middleware above
...
//         reply = req.crimeData.filter((item) => {
...
//         console.log('how many crimes match the query?', reply.length);
//       } else {
//         reply = req.crimeData;
//       }
...
//       res.json({
//         message: 'Something went wrong in our crimeDataPG GET request',
//         error: err
//       });
//     }
...
//   .post((req, res) => crimeControllers.handlePostRequest(req, res))
//   .put((req, res) => crimeControllers.handlePutRequest(req, res))
//   .delete((req, res) => crimeControllers.handleDeleteRequest(req, res));
...
//   .get(async (req, res) => {
//     try {
//       console.log('Touched crimeData /:category');
//       // + req.params.category
