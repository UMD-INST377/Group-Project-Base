...
const addProfiles = "INSERT INTO InternetProfiles('profile_ID', 'twitter', 'instagram', 'facebook', 'website') VALUES('{$req.body.profile_ID}',n'{$req.body.twitter}','{$req.body.instagram}', '{$req.body.facebook}', '{$req.body.website}')";
